		...
		$fields = apply_filters( 'modula_gallery_fields', array(
			'general' => array(
				...
				"img_size"       => array(
					...
					"type"        => "text",
					"description" => esc_html__( 'Minimum width or height of the images (i.e.: 100% or 500px)', 'modula-gallery' ),
					"excludeFrom" => array(),
					'priority' => 50,
				),
				"margin"         => array(
					...
					"type"        => "text",
					"description" => esc_html__( 'Margin between images (i.e.: 10px)', 'modula-gallery' ),
					"mu"          => "px",
					"excludeFrom" => array(),
					'priority' => 60,
				),
