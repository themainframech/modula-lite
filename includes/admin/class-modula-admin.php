...
class Modula_Admin {
	...
	public function register_submenus() {
		...
		add_submenu_page( 'edit.php?post_type=modula-gallery', __( 'Modula', 'modula-lite' ), __( 'Modula', 'modula-lite' ), 'manage_options', 'modula', array( $this, 'show_submenu' ) );
		add_submenu_page( 'edit.php?post_type=modula-gallery', __( 'Addons', 'modula-lite' ), __( 'Addons', 'modula-lite' ), 'manage_options', 'modula-addons', array( $this, 'show_addons' ) );
	...
	public function show_submenu() {
		$this->tabs = apply_filters( 'modula_admin_page_tabs', array(
			'general' => array(
				'label'    => esc_html__( 'General', 'modula-lite' ),
				'priority' => 10
			),
		) );
