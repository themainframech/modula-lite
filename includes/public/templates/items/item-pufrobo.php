...
<div class="item effect-pufrobo<?php echo $hasTitle ?>" data-width="<?php echo esc_attr( $image['width'] ) ?>" data-height="<?php echo esc_attr( $image['height'] ) ?>">
		...
		<div class="figc">
			<div class="figc-inner">
				<?php if ( ! $data->hide_title ): ?>
					<h2 class='jtg-title'><?php echo esc_html( $image['title'] ); ?></h2>
				<?php endif ?>
				<?php if ( ! $data->hide_description ): ?>
					<p class="description"><?php echo wp_kses_post( $image['caption'] ); ?></p>
				<?php endif ?>
			</div>
		</div>
	</a>
