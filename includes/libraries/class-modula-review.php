...
class Modula_Review {
	...
	function __construct( $args ) {
		...
		$this->messages = array(
			'notice'  => __( "Hey, I noticed you have installed our plugin for %s day - that's awesome! Could you please spare us a minute and give it a 5-star rating on WordPress? Help others build awesome galleries too!", 'modula-gallery' ),
			'rate'    => __( 'Ok, you rock!', 'modula-gallery' ),
			'rated'   => __( 'I already did', 'modula-gallery' ),
			'no_rate' => __( 'Nope, not yet.', 'modula-gallery' ),
		);
	...
	private function value() {
		...
		$value = get_transient( 'modula-galleries' );
		...
		set_transient( 'modula-galleries', $galleries->post_count, 6 * HOUR_IN_SECONDS );

		return $galleries->post_count;
